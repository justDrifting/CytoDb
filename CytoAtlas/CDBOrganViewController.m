    ...
    for (NSDictionary *sourceDict in sourceArray) {
       ...
       // organ.organName = [sourceDict objectForKey:@"sourceName"];
        ...
        for (NSDictionary *dxDict in conditionArray ) {
            ...
            [condition setValue:[dxDict objectForKey:@"dxOrder"] forKey:@"conditionOrder"];
            ...
            for (NSDictionary *slideDict in slideArray) {
                ...
                //Debug step
                if ([[slideDict objectForKey:@"slideDescription"] isKindOfClass:[NSNull class]] ) {
                    NSLog(@"Offending Slide Name is %@",[slideDict objectForKey:@"slideName"]);
                }
                //Debug Step end
